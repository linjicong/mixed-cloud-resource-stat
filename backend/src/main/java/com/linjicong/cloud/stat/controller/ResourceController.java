...
public class ResourceController {
    ...
    public ResponseEntity<?> getHuaweiResources(@PathVariable String type) {
        try {
            List<?> resources = switch (type.toLowerCase()) {
                ...
                case "dc" -> hCloudDcMapper.selectList(null);
                case "ga" -> hCloudGaMapper.selectList(null);
                case "eg" -> hCloudEgMapper.selectList(null);
                case "apm" -> hCloudApmMapper.selectList(null);
                case "cloudtable" -> hCloudCloudTableMapper.selectList(null);
                case "dataartsstudio", "dataarts" -> hCloudDataArtsStudioMapper.selectList(null);
                case "dis" -> hCloudDisMapper.selectList(null);
                case "mas" -> hCloudMasMapper.selectList(null);
                case "mpc" -> hCloudMpcMapper.selectList(null);
                case "clouddc" -> hCloudCloudDcMapper.selectList(null);
                case "kvs" -> hCloudKvsMapper.selectList(null);
                case "eds" -> hCloudEdsMapper.selectList(null);
                case "tics" -> hCloudTicsMapper.selectList(null);
                case "organizations", "org" -> hCloudOrganizationsMapper.selectList(null);
                case "ram" -> hCloudRamMapper.selectList(null);
                case "coc" -> hCloudCocMapper.selectList(null);
                default -> null;
            };
    ...
    public ResponseEntity<?> getAliyunResources(@PathVariable String type) {
        try {
            List<?> resources = switch (type.toLowerCase()) {
                case "ack" -> aCloudAckMapper.selectList(null);
                case "acr" -> aCloudAcrMapper.selectList(null);
                case "actiontrail" -> aCloudActionTrailMapper.selectList(null);
                case "alb" -> aCloudAlbMapper.selectList(null);
                case "analyticdb" -> aCloudAnalyticDbMapper.selectList(null);
                case "apigateway" -> aCloudApiGatewayMapper.selectList(null);
                case "cbh" -> aCloudCbhMapper.selectList(null);
                case "cdn" -> aCloudCdnMapper.selectList(null);
                case "cen" -> aCloudCenMapper.selectList(null);
                case "clickhouse" -> aCloudClickHouseMapper.selectList(null);
                case "cloudfirewall" -> aCloudCloudFirewallMapper.selectList(null);
                case "cms" -> aCloudCmsMapper.selectList(null);
                case "config" -> aCloudConfigMapper.selectList(null);
                case "ddos" -> aCloudDdosMapper.selectList(null);
                case "disk" -> aCloudDiskMapper.selectList(null);
                case "dns" -> aCloudDnsDomainMapper.selectList(null);
                case "dns_records" -> aCloudDnsDomainRecordsMapper.selectList(null);
                case "dsc" -> aCloudDscMapper.selectList(null);
                case "dts" -> aCloudDtsMapper.selectList(null);
                case "ecs" -> aCloudEcsMapper.selectList(null);
                case "eip" -> aCloudEipMapper.selectList(null);
                case "elasticsearch" -> aCloudElasticsearchMapper.selectList(null);
                case "emr" -> aCloudEmrMapper.selectList(null);
                case "ess" -> aCloudEssMapper.selectList(null);
                case "fc" -> aCloudFcMapper.selectList(null);
                case "ga" -> aCloudGaMapper.selectList(null);
                case "hologres" -> aCloudHologresMapper.selectList(null);
                case "hss" -> aCloudHssMapper.selectList(null);
                case "iot" -> aCloudIoTMapper.selectList(null);
                case "kafka" -> aCloudKafkaMapper.selectList(null);
                case "kms" -> aCloudKmsMapper.selectList(null);
                case "lindorm" -> aCloudLindormMapper.selectList(null);
                case "live" -> aCloudLiveMapper.selectList(null);
                case "maxcompute" -> aCloudMaxComputeMapper.selectList(null);
                case "mongodb" -> aCloudMongoDbMapper.selectList(null);
                case "mse" -> aCloudMseMapper.selectList(null);
                case "nas" -> aCloudNasMapper.selectList(null);
                case "nat" -> aCloudNatGatewayMapper.selectList(null);
                case "nlb" -> aCloudNlbMapper.selectList(null);
                case "oos" -> aCloudOosMapper.selectList(null);
                case "oss" -> aCloudOssMapper.selectList(null);
                case "polardb" -> aCloudPolarDbMapper.selectList(null);
                case "quota" -> aCloudQuotaMapper.selectList(null);
                case "rabbitmq" -> aCloudRabbitMqMapper.selectList(null);
                case "rds" -> aCloudRdsMapper.selectList(null);
                case "redis" -> aCloudRedisMapper.selectList(null);
                case "rocketmq" -> aCloudRocketMQMapper.selectList(null);
                case "sae" -> aCloudSaeMapper.selectList(null);
                case "sag" -> aCloudSagMapper.selectList(null);
                case "securitygroup" -> aCloudSecurityGroupMapper.selectList(null);
                case "selectdb" -> aCloudSelectDbMapper.selectList(null);
                case "slb" -> aCloudSlbMapper.selectList(null);
                case "sls" -> aCloudSlsMapper.selectList(null);
                case "sms" -> aCloudSmsMapper.selectList(null);
                case "ssl" -> aCloudSslMapper.selectList(null);
                case "storagegateway" -> aCloudStorageGatewayMapper.selectList(null);
                case "vod" -> aCloudVodMapper.selectList(null);
                case "vpcendpoint" -> aCloudVpcEndpointMapper.selectList(null);
                case "vpc" -> aCloudVpcMapper.selectList(null);
                case "vpngateway" -> aCloudVpnGatewayMapper.selectList(null);
                case "waf" -> aCloudWafMapper.selectList(null);
                default -> null;
            };
            if (resources != null) { return ResponseEntity.ok(resources); }
            else { return ResponseEntity.badRequest().body("unsupported type: " + type); }
